...
⚠️ 极短词独段禁止。以下两类在任何上下文中都不能独立成段：
- 人名独段："凌瑶。" → 加情绪标记（"凌瑶？""又是凌瑶。"）或融进叙事（"凌瑶站在门口。"）
- 转折/动作词独段："除非。""悬停。""然后。""接着。" → 这些是叙事连接词，不是独立句子。融进前后句
如果你写了一个1-4字的词+句号独占一段，问自己：能不能融进前一句或后一句？能→融。不能→扩展成有内容的句子。连续单句成段不超过2句。
